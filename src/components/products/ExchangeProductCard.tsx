          ...
          <>
            ...
            {hasImage && (
              <Image
                ...
                resizeMode="cover"
                className="absolute bottom-0 z-10 w-full h-linearImageHeight"
              />
            )}

            <View className="absolute inset-x-0 bottom-0 z-20 px-2 py-2">
              <View className="flex-row items-end justify-between">
                <View className="flex-1">
                  <Text className="mb-1 text-base font-bold text-white">
                    {item.title}
                  </Text>
                  <Text className="text-sm text-white opacity-80" style={{marginTop: -9, fontSize: 9}}>
                    {item.category}
                  </Text>
                </View>
              </View>
              ...
              <View className="flex-row items-center justify-between">
                ...
                >
                  {isLiking ? (
                    <ActivityIndicator size={16} color="#03233A" />
                  ) : (
                    <HeartIcon
                      size={16}
